angular.module('reportingApp').directive('ratingPotential', function () {
		...
		directive.template = function(tElement, tAttrs) { 
			...
			return '{{ratingType}}: <rating ng-model="observation.rating.potential" max="5" readonly="false" state-on="\'fa fa-bullseye\'" state-off="\'fa fa-circle-o\'" on-hover="hoveringOver(value)" on-leave="overStar = null"> \
					</rating> \
